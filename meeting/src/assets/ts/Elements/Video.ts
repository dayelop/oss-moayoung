  ...
  addCodeToVideoElement() {
    $(this.element).find('.video-wrap').append(`
            <div class="video-info-wrap" v-on:dblclick="expand" v-bind:class="{'cammeraoff': cameraOff  && !screenSharing}">
                ...
                ${
                  this.element === this.myVideo
                    ? ''
                    : `<div class="onoffswitch">
                <input type="radio" name="lipDetecting" class="onoffswitch-checkbox" id="${
                  this.partner.id + 12
                }" value="${this.partner.id}" onclick="libSelect()">
            ...
            <div class="onoffswitch">
                <input type="checkbox" name="subtitle" class="onoffswitch-checkbox" id="subtitle-${
                  this.partner.id
                }" value="${this.partner.id}">
                <label class="onoffswitch-label" for="subtitle-${
                  this.partner.id
                }">
                    <div class="onoffswitch-inner">
                        <div class="onoffswitch-active">
